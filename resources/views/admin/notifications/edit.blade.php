...
<div class="section">
        <div class="section__top">
          ...
          <div class="breadcrumbs"><a class="breadcrumbs__link" href="{{route('notifications.index')}}">Events &amp; Push Notifications</a><a class="breadcrumbs__link">Edit</a><a class="breadcrumbs__link"></a></div>
        </div>
