...
<div class="section__top">
    ...
    <div class="breadcrumbs"><a class="breadcrumbs__link" href="{{ route('basicPages')}}">Basic Pages</a><a class="breadcrumbs__link"></a><a class="breadcrumbs__link"></a></div>
</div>
<div class="section__container">
    ...
    <tr class="table__row js-view" data-href="{{ route('basicPages.informationPage',$contents->id) }}">
        ...
        <td class="table__details">
            <div class="table__content">{{ $contents->content }}</div>
        </td>
        </tr>
    @endforeach
    </tbody>
