...
<div class="section">
        <div class="section__top">
          ...
          <div class="breadcrumbs"><a class="breadcrumbs__link" href="{{ route('survey.index')}}">Survey</a><a class="breadcrumbs__link">{{ $detail->title}}</a><a class="breadcrumbs__link"></a></div>
        </div>
