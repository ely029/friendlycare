...
<div class="section">
  ...
  <div class="section__container">
    <form class="form form--ads">
      ...
      <div class="form__inline">
        <div class="form__content"><span class="form__text">{{ $datas->count_views }}</span><label class="form__label">Views</label></div>
        <div class="form__content"><span class="form__text">{{ $datas->count_clicks }}</span><label class="form__label">Clicks</label></div>
      </div>
