...
@include('includes.sidebar')
      ...
      <div class="section">
        <div class="section__top">
          ...
          <div class="breadcrumbs"><a class="breadcrumbs__link" href="{{ route('userManagement')}}">User management</a><a class="breadcrumbs__link">Edit user</a><a class="breadcrumbs__link"></a></div>
        </div>
